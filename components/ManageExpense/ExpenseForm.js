...
const ExpenseForm = ({
  ...
  const [inputs, setInputs] = useState({
    ...
    date: {
      value: defaultValues ? getFormattedDate(defaultValues.date) : "", // check util for reference
      isValid: true,
    },
    description: {
  ...
  const submitHandler = () => {
    const expenseData = {
      amount: +inputs.amount.value, // this converts a string into a number
      date: new Date(inputs.date.value), // converts the string, if formatted correctly, into a date object
    ...
    <View style={styles.form}>
      ...
      <View style={styles.inputsRow}>
        <Input
          ...
          label="Amount"
          invalid={!inputs.amount.isValid} // invalid true if amount is NOT valid
          textInputConfig={{
